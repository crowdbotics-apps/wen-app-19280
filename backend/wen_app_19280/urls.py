"""wen_app_19280 URL Configuration
...
admin.site.site_title = "WEN App Admin Portal"
admin.site.index_title = "WEN App Admin"

# swagger
api_info = openapi.Info(
    title="WEN App API",
    default_version="v1",
    description="API documentation for WEN App App",
)
